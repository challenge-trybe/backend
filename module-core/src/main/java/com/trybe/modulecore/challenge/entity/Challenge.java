...
public class Challenge {
    public Challenge(String title, String description, LocalDate startDate, LocalDate endDate, int capacity, ChallengeCategory category, String proof_way, int proof_count) {
        this.title = title;
        ...
        this.proof_way = proof_way;
        this.proof_count = proof_count;
    }
    ...
    public void updateProof(String proof_way, int proof_count) {
        this.proof_way = proof_way;
        this.proof_count = proof_count;
    }
