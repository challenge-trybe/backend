...
public class AuthenticationFixtures {
    ...
    public static final UUID 유저_UUID = UUID.randomUUID();
    ...
    public static TokenResponse 토큰_반환 = TokenResponse.from(UserFixtures.요약_회원_응답, 유저_UUID, accessToken, refreshToken);
