...
@Component
public class PostDeleteEventHandler implements PostEventHandler {
    private final PostCreatedAtCache postCreatedAtCache;
    private final PopularPostCache popularPostCache;

    public PostDeleteEventHandler(PostCreatedAtCache postCreatedAtCache, PopularPostCache popularPostCache) {
