...
public class UserRequest {
    ...
    private static final String EMAIL_VALUE = "아이디를 입력해주세요.";
    ...
    private static final String NICKNAME_FORMAT = "닉네임 형식이 다릅니다.";
    ...
    private static final String PASSWORD_FORMAT = "비밀번호는 영어와 숫자로 포함해서 6~12자리 이내로 입력해주세요.";

    private static final String BIRTH_REGEXP = "^(?:\\d{4}-\\d{2}-\\d{2})?$";
    private static final String BIRTH_FORMAT = "생년월일 형식이 다릅니다.";
